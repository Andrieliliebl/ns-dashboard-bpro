                        ...
                        <div class="ns-plan-obra col-8">
                            ...
                            <div class="row">
                                <div class="col-4 mt-4">
                                    <h3 class="m-0 text-dark text-center">75<i
                                            class="px-2 ti ti-circle-filled text-dark mb-2"></i></h3>
                                    <small class="text-center ms-4">Dias planejados</small>
                                </div>
                                <div class="col-4 mt-4">
                                    <h3 class="m-0 text-dark text-center">25<i
                                            class="px-2 ti ti-circle-filled ns-text-blue mb-2"></i></h3>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row d-flex justify-content-between mt-4">
                                            ...
                                            <div class="col-5 card">
                                                <span class="avatar-initial rounded"><i
                                                        class="ti ti-alert-octagon ti-sm"></i></span>
